"""inclusao coluna receipt_type em users

Revision ID: 98cd94a94750
Revises: 831a77552aa2
Create Date: 2025-04-17 06:10:37.340234
...
revision: str = '98cd94a94750'
down_revision: Union[str, None] = '831a77552aa2'
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('receipt_type', sa.Integer(), nullable=True))
    op.create_unique_constraint(None, 'users', ['receipt_type'], schema='elderly_care')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(None, 'users', schema='elderly_care', type_='unique')
    op.drop_column('users', 'receipt_type')
