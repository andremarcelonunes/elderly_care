...
Revision ID: 831a77552aa2
Revises: 26a6a3ab9136
Create Date: 2025-04-16 12:40:17.983626
...
revision: str = '831a77552aa2'
down_revision: Union[str, None] = '26a6a3ab9136'
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('receipt_type', sa.Integer(), nullable=False))
