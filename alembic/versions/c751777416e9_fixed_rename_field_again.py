"""Fixed rename field again

Revision ID: c751777416e9
Revises: 670f191eddd9
Create Date: 2025-02-15 21:41:36.311733
...
revision: str = 'c751777416e9'
down_revision: Union[str, None] = '670f191eddd9'
...
def upgrade() -> None:
    ...
    op.add_column('notification_configs', sa.Column('notify_level', sa.Integer(), nullable=False))
    ...
    op.drop_column('notification_configs', 'notify_level_info')
...
def downgrade() -> None:
    ...
    op.add_column('notification_configs', sa.Column('notify_level_info', sa.INTEGER(), autoincrement=False, nullable=False))
    ...
    op.drop_column('notification_configs', 'notify_level')
