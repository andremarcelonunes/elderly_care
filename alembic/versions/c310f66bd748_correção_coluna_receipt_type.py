"""correção coluna receipt_type

Revision ID: c310f66bd748
Revises: 98cd94a94750
Create Date: 2025-04-17 07:13:25.970481
...
revision: str = 'c310f66bd748'
down_revision: Union[str, None] = '98cd94a94750'
...
def upgrade() -> None:
    ...
    op.drop_constraint('users_receipt_type_key', 'users', type_='unique')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_unique_constraint('users_receipt_type_key', 'users', ['receipt_type'])
