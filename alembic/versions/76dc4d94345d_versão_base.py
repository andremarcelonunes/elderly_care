...
Revision ID: 76dc4d94345d
Revises: 
Create Date: 2025-04-01 14:18:08.980553
...
def upgrade() -> None:
    ...
    op.add_column('client_contact_association', sa.Column('type', sa.String(length=50), nullable=True))
