"""alteracao na tabela de relacionamento do contato

Revision ID: 26a6a3ab9136
Revises: 76dc4d94345d
Create Date: 2025-04-01 14:38:42.860437
...
revision: str = '26a6a3ab9136'
down_revision: Union[str, None] = '76dc4d94345d'
...
def upgrade() -> None:
    ...
    op.drop_constraint('attendant_specialties_attendant_id_fkey', 'attendant_specialties', type_='foreignkey')
    op.drop_constraint('attendant_specialties_specialty_id_fkey', 'attendant_specialties', type_='foreignkey')
    op.create_foreign_key(None, 'attendant_specialties', 'specialties', ['specialty_id'], ['id'], source_schema='elderly_care', referent_schema='elderly_care', onupdate='CASCADE', ondelete='CASCADE')
    op.create_foreign_key(None, 'attendant_specialties', 'attendants', ['attendant_id'], ['user_id'], source_schema='elderly_care', referent_schema='elderly_care', onupdate='CASCADE', ondelete='CASCADE')
    op.drop_constraint('attendant_teams_attendant_id_fkey', 'attendant_teams', type_='foreignkey')
    op.drop_constraint('attendant_teams_team_id_fkey', 'attendant_teams', type_='foreignkey')
    op.create_foreign_key(None, 'attendant_teams', 'attendants', ['attendant_id'], ['user_id'], source_schema='elderly_care', referent_schema='elderly_care', onupdate='CASCADE', ondelete='CASCADE')
    op.create_foreign_key(None, 'attendant_teams', 'teams', ['team_id'], ['team_id'], source_schema='elderly_care', referent_schema='elderly_care', onupdate='CASCADE', ondelete='CASCADE')
    ...
    op.create_foreign_key(None, 'attendants', 'functions', ['function_id'], ['id'], source_schema='elderly_care', referent_schema='elderly_care', onupdate='CASCADE', ondelete='CASCADE')
    op.create_foreign_key(None, 'attendants', 'users', ['user_id'], ['id'], source_schema='elderly_care', referent_schema='elderly_care', onupdate='CASCADE', ondelete='CASCADE')
    ...
    op.add_column('client_contact_association', sa.Column('type_contact', sa.String(length=50), nullable=True))
    ...
    op.drop_column('client_contact_association', 'type')
    ...
    op.drop_constraint('document_function_id_fkey', 'document_function', type_='foreignkey')
    op.create_foreign_key(None, 'document_function', 'functions', ['id'], ['id'], source_schema='elderly_care', referent_schema='elderly_care')
...
def downgrade() -> None:
    ...
    op.drop_constraint(None, 'document_function', schema='elderly_care', type_='foreignkey')
    op.create_foreign_key('document_function_id_fkey', 'document_function', 'functions', ['id'], ['id'])
    ...
    op.add_column('client_contact_association', sa.Column('type', sa.VARCHAR(length=50), autoincrement=False, nullable=True))
    ...
    op.drop_column('client_contact_association', 'type_contact')
    ...
    op.drop_constraint(None, 'attendants', schema='elderly_care', type_='foreignkey')
    op.create_foreign_key('attendants_user_id_fkey', 'attendants', 'users', ['user_id'], ['id'], onupdate='CASCADE', ondelete='CASCADE')
    op.create_foreign_key('attendants_function_id_fkey', 'attendants', 'functions', ['function_id'], ['id'], onupdate='CASCADE', ondelete='CASCADE')
    op.drop_constraint(None, 'attendant_teams', schema='elderly_care', type_='foreignkey')
    op.drop_constraint(None, 'attendant_teams', schema='elderly_care', type_='foreignkey')
    op.create_foreign_key('attendant_teams_team_id_fkey', 'attendant_teams', 'teams', ['team_id'], ['team_id'], onupdate='CASCADE', ondelete='CASCADE')
    op.create_foreign_key('attendant_teams_attendant_id_fkey', 'attendant_teams', 'attendants', ['attendant_id'], ['user_id'], onupdate='CASCADE', ondelete='CASCADE')
    op.drop_constraint(None, 'attendant_specialties', schema='elderly_care', type_='foreignkey')
    op.drop_constraint(None, 'attendant_specialties', schema='elderly_care', type_='foreignkey')
    op.create_foreign_key('attendant_specialties_specialty_id_fkey', 'attendant_specialties', 'specialties', ['specialty_id'], ['id'], onupdate='CASCADE', ondelete='CASCADE')
    op.create_foreign_key('attendant_specialties_attendant_id_fkey', 'attendant_specialties', 'attendants', ['attendant_id'], ['user_id'], onupdate='CASCADE', ondelete='CASCADE')
